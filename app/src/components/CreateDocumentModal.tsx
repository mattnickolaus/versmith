...
import { createDocumentRequest } from '../services/documents.js';
import type { CreateDocumentRequestData } from '../services/documents.js';
...
export default function CreateDocumentModal({ open, setOpen }) {
  ...
  const handleDocumentCreate = (event) => {
    ...
    if (isAuthenticated) {
      ...
      console.log("Did not get access token, needs refresh");
      navigate('/');
    }
